...
{	
 ...
 // resolve units
	...
	resolveSize : ( value ) => builder.resolveUnit( value, 'ex' ),
	...
	resolveOffset: ( ra, defaultUnit ) => ra instanceof Array ? ra.map( (value) => builder.resolveUnit( value, defaultUnit || 'em' ) ) : [0,0], 
